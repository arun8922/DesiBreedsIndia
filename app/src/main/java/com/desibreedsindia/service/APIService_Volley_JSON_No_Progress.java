 ...
 */
public class APIService_Volley_JSON_No_Progress extends AsyncTask<String, String, String> {
...
//    private Dialog volleyProgressBarDialog;
    ...
    public APIService_Volley_JSON_No_Progress(Context ctx, APIResult res, JSONObject j, boolean getmethod) {
        mContext = ctx;
        response = res;
        this.data = j;
        GetMethod = getmethod;
    ...
    public APIService_Volley_JSON_No_Progress(Context ctx, APIResult res, boolean getmethod) {
        mContext = ctx;
        response = res;
        GetMethod = getmethod;
    }
...
//            String url = CommonData.BasePath + "lang=" + SessionSave.getSession("Lang", mContext) + "&" + params[0];
            ...
            System.out.println("Driver Api request: " + url);
            System.out.println("Driver Api request" + "data :" + data);
            if (GetMethod) {
                requestingMethod = 0;
            } else {
                requestingMethod = 1;
